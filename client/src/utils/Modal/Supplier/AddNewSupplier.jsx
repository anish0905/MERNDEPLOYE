                        ...
                        <div key={index} className="flex flex-row">
                            <div className="w-1/2 pr-2">
                                ...
                                {index === formData.products.length - 1 && (
                                   ...
                                   <button type="button" onClick={handleAddProduct} className="mr-2 p-2 bg-green-500 w-16 rounded-md flex items-center justify-center"><FaPlus /></button>
                                   {formData.products.length > 1 && (
                                       <button type="button" onClick={() => handleDeleteProduct(index)} className="p-2 bg-red-500 rounded-md w-16 flex items-center justify-center"><FaMinus /></button>
                                   )}
                               </div>
